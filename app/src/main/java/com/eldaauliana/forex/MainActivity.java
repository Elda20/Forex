...
public class MainActivity extends AppCompatActivity {
    ...
    private SwipeRefreshLayout swifeRefreshLayout1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swifeRefreshLayout1 = (SwipeRefreshLayout)findViewById(R.id.swipeRefreshLayout1);
    ...
    private void initSwipeRefreshLayout() {
        swifeRefreshLayout1.setOnRefreshListener(() -> {
            initForex();

            swifeRefreshLayout1.setRefreshing(false);
        });
    }
    ...
    private void initForex() {
        ...
        String url = "https://openexchangerates.org/api/latest.json?app_id=b0f5b4bcc07f4150b63da8a06a71a027";

        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
        asyncHttpClient.get(url, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                //Log.d(*ld*, new String(responseBody));
                Gson gson = new Gson();
